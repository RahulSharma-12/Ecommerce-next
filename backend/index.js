...
// mongoose.connect(`mongodb+srv://{process.env.MONGO_DB_USER}:{process.env.MONGO_DB_PASSWORD}@ecommerce-store.ldbpp.mongodb.net/{process.env.MONGO_DB_DATABASE}retryWrites=true&w=majority`)

mongoose.connect(`mongodb+srv://rahul1112sh:rahul1112sh@ecommerce-store.ldbpp.mongodb.net/`)
